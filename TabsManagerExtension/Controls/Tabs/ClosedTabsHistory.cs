...
namespace TabsManagerExtension.Controls.Tabs {
    ...
    internal sealed class ClosedTabsHistory {
        ...
        public ClosedTabEntry CreateEntry(TabItemBase tabItem, TabItemsGroupBase? group) {
        ...
        public void MarkClosing(TabItemBase tabItem) {
            _tabsBeingClosed.Add(GetKey(tabItem));
        }

        public bool ConsumeClosingMark(TabItemBase tabItem) {
            return _tabsBeingClosed.Remove(GetKey(tabItem));
        }

        public void RemoveClosingMark(TabItemBase tabItem) {
        ...
        private static ClosedTabGroupKind GetGroupKind(TabItemsGroupBase? group) {
        ...
        private static string GetKey(TabItemBase tabItem) {
