    ...
    public static class VsCommandMapper {
        ...
        public static Key? TryMapStd2kToKey(VSConstants.VSStd2KCmdID cmd) {
            return cmd switch {
                ...
                VSConstants.VSStd2KCmdID.HOME => Key.Home,
                VSConstants.VSStd2KCmdID.HOME_EXT => Key.Home,
                VSConstants.VSStd2KCmdID.BOL => Key.Home,
                VSConstants.VSStd2KCmdID.BOL_EXT => Key.Home,
                VSConstants.VSStd2KCmdID.END => Key.End,
                VSConstants.VSStd2KCmdID.END_EXT => Key.End,
                VSConstants.VSStd2KCmdID.EOL => Key.End,
                VSConstants.VSStd2KCmdID.EOL_EXT => Key.End,
