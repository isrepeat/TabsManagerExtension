...
using TabsManagerExtension.Controls.Tabs;
...
namespace TabsManagerExtension.Controls {
    public partial class TabsManagerToolWindowControl : Helpers.BaseUserControl {
        ...
        // Internal:
        private VisualStudioTabEventBridge? _visualStudioTabEventBridge;

        private TabsStateReconciler? _tabsStateReconciler;
        private ToolWindowSessionManager? _toolWindowSessionManager;
        private readonly SolutionFileChangeMonitor _solutionFileChangeMonitor;
        private TabCollectionManager _tabCollectionManager;
        private readonly ClosedTabsHistory _closedTabsHistory = new();
        private ClosedTabsRestorer? _closedTabsRestorer;
        ...
        private readonly TabAppearanceManager _tabAppearanceManager = new();
        private readonly TabRenameService _tabRenameService = new();
        private readonly TabMenuItemFactory _tabMenuItemFactory;
        private ProjectContextController? _projectContextController;
        private VirtualMenuController? _virtualMenuController;
        private TabActivationSynchronizer? _tabActivationSynchronizer;
        private TabsWorkspaceSynchronizer? _tabsWorkspaceSynchronizer;
        private TabInputController? _tabInputController;
        private TabCommandController? _tabCommandController;
        ...
        public TabsManagerToolWindowControl() {
            ...
            _solutionFileChangeMonitor = new SolutionFileChangeMonitor(this.Dispatcher);
            ...
            _tabMenuItemFactory = new TabMenuItemFactory(
                this.OnCopyTabName,
                this.OnCopyTabPath,
        ...
        private void OnUnloaded(object sender, RoutedEventArgs e) {
            ...
            Services.ExtensionStatusService.Instance.FeatureReadinessChanged -= this.OnFeatureReadinessChanged;
            _toolWindowSessionManager?.Save(_tabsWorkspaceSynchronizer?.IsSolutionClosing == true);
        ...
        private void InitializeDTE() {
            ThreadHelper.ThrowIfNotOnUIThread();
            _toolWindowSessionManager = new ToolWindowSessionManager(PackageServices.Dte2, this.Dispatcher);
            _visualStudioTabEventBridge = new VisualStudioTabEventBridge(PackageServices.Dte2);
            ...
            _visualStudioTabEventBridge.SolutionClosing += this.OnSolutionClosing;
        ...
        private void InitializeTabItemsSelectionCoordinator() {
            _tabCollectionManager = new TabCollectionManager();
            ...
            _projectContextController = new ProjectContextController(
                PackageServices.Dte2,
                this.VirtualMenuControl,
                _tabCollectionManager,
                _tabItemsSelectionCoordinator
            );
            _virtualMenuController = new VirtualMenuController(
                this.VirtualMenuControl,
                this.VirtualMenuItems,
                _tabMenuItemFactory,
                _projectContextController
            );
            _closedTabsRestorer = new ClosedTabsRestorer(
                PackageServices.Dte2,
                _tabCollectionManager,
            ...
            _tabCommandController = new TabCommandController(
                this.VirtualMenuControl,
                _tabCollectionManager,
                _closedTabsHistory,
                _tabItemsSelectionCoordinator,
            ...
            _tabInputController = new TabInputController(
                this,
                this.FocusStealer,
                this.Resources,
                this.Dispatcher,
            ...
            _tabActivationSynchronizer = new TabActivationSynchronizer(
                PackageServices.Dte2,
                this.Dispatcher,
                _tabCollectionManager,
                _tabItemsSelectionCoordinator,
                ...
                () => _tabsWorkspaceSynchronizer?.IsSolutionClosing == true,
                this.UpdateWindowTabsInfo
            );
            _tabsWorkspaceSynchronizer = new TabsWorkspaceSynchronizer(
                PackageServices.Dte2,
                this.Dispatcher,
                _tabCollectionManager,
                _closedTabsHistory,
        ...
        private void InitializeBackgroundRoutine() {
            _tabsStateReconciler = new TabsStateReconciler(
                PackageServices.Dte2,
                this.Dispatcher,
                _tabCollectionManager,
                this.UpdateWindowTabsInfo
        ...
        private void OnTabItemContextMenuOpen(object parameter) {
            if (parameter is not Controls.MenuControl.MenuOpeningArgs contextMenuOpeningArgs ||
                contextMenuOpeningArgs.DataContext is not TabItemBase tabItem) {
