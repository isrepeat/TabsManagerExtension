...
namespace TabsManagerExtension.Controls.Tabs {
    ...
    internal sealed class TabActivationSynchronizer {
        ...
        private readonly Func<bool> _isSolutionClosing;
        ...
        public TabActivationSynchronizer(
            ...
            _isSolutionClosing = isSolutionClosing;
        ...
        public void HandleWindowActivated(EnvDTE.Window gotFocus) {
            ...
            if (gotFocus.Document != null) {
                tabItem = _tabCollectionManager.Find(gotFocus.Document.FullName) ??
                    _tabCollectionManager.AddAutomatically(new TabItemDocument(gotFocus.Document));
            }
            else {
            ...
            if (tabItem is TabItemWindow) {
                ...
                _toolWindowSessionManager.Save(_isSolutionClosing());
            }
        ...
        public void HandleWindowFrameActivated(IVsWindowFrame windowFrame) {
            ...
            TabItemBase? activeFrameTabItem = activeWindow?.Document != null
        ...
        public void SelectActivated(TabItemBase tabItem) {
