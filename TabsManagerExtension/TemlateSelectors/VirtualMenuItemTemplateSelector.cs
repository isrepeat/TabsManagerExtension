...
namespace TabsManagerExtension.TemlateSelectors {
    public class VirtualMenuItemTemplateSelector : Controls.MenuControl.MenuItemTemplateSelectorBase {
        ...
        public DataTemplate? DocumentProjectGroupContextCommandTemplate { get; set; }
        ...
        public override DataTemplate? SelectTemplate(object item, DependencyObject container) {
            if (item is Helpers.MenuItemCommand menuItemCommand) {
                ...
                else if (menuItemCommand.CommandParameterContext is State.Document.DocumentProjectReferencesInfo.GroupContextEntry groupContextEntry) {
                    return this.DocumentProjectGroupContextCommandTemplate;
                }
